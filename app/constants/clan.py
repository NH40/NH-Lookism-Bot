...
CLAN_SHOP_ITEMS: list[ClanShopItem] = [
    ...
    # ── Статисты (цена = цена 1 статиста в app/data/shop.py × 100 × 5) ────────
    ClanShopItem("squad_s_all",   "🟥 100×S всем",    "100 статистов S всем",    1_000_000,  "squad", "squad", {"rank": "S",   "amount": 100}),
    ClanShopItem("squad_ss_all",  "💠 100×SS всем",   "100 статистов SS всем",   1_200_000,  "squad", "squad", {"rank": "SS",  "amount": 100}),
    ClanShopItem("squad_sss_all", "🔷 100×SSS всем",  "100 статистов SSS всем",  1_500_000,  "squad", "squad", {"rank": "SSS", "amount": 100}),
    ClanShopItem("squad_sr_all",  "🌟 100×SR всем",   "100 статистов SR всем",   2_250_000,  "squad", "squad", {"rank": "SR",  "amount": 100}),
    ClanShopItem("squad_ssr_all", "✨ 100×SSR всем",  "100 статистов SSR всем",  2_575_000,  "squad", "squad", {"rank": "SSR", "amount": 100}),
    ClanShopItem("squad_ur_all",  "💎 100×UR всем",   "100 статистов UR всем",   3_225_000,  "squad", "squad", {"rank": "UR",  "amount": 100}),
    ClanShopItem("squad_lr_all",  "👑 100×LR всем",   "100 статистов LR всем",   5_000_000,  "squad", "squad", {"rank": "LR",  "amount": 100}),
    ClanShopItem("squad_mp_all",  "🔱 100×MP всем",   "100 статистов MP всем",   8_350_000,  "squad", "squad", {"rank": "MP",  "amount": 100}),
    ClanShopItem("squad_x_all",   "⚡ 100×X всем",    "100 статистов X всем",   10_000_000,  "squad", "squad", {"rank": "X",   "amount": 100}),
    ClanShopItem("squad_xx_all",  "🌀 100×XX всем",   "100 статистов XX всем",  12_500_000,  "squad", "squad", {"rank": "XX",  "amount": 100}),
    ClanShopItem("squad_xxx_all", "🔥 100×XXX всем",  "100 статистов XXX всем", 20_000_000,  "squad", "squad", {"rank": "XXX", "amount": 100}),
    ClanShopItem("squad_dx_all",  "💀 100×DX всем",   "100 статистов DX всем",  25_000_000,  "squad", "squad", {"rank": "DX",  "amount": 100}),
    ClanShopItem("squad_err_all", "❌ 100×ERROR всем", "100 ERROR всем",        30_000_000,  "squad", "squad", {"rank": "ERROR","amount": 100}),
