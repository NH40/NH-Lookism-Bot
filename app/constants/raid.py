...
# ── Бизнес-фрагменты ─────────────────────────────────────────────────────────
BUSINESS_FRAGMENTS_MAX_PER_RAID = 30

# Стоимость крафта одного бонусного района (экспансия без захвата городов)
# Тир 1 (районы 1–50): 50 фрагментов
# Тир 2 (районы 51–100): 80 фрагментов
BUSINESS_DISTRICT_COST = 50
BUSINESS_DISTRICT_COST_TIER2 = 80
BUSINESS_DISTRICTS_TIER1_MAX = 50   # граница тиров
BUSINESS_DISTRICTS_MAX = 100        # абсолютный максимум бонусных районов

# Гений бизнеса (патч 1.3.1): 4 трека, константы стоимости/% — в app/config/game_balance.py
# (BIZ_GENIUS_LEVEL_COSTS/CAPACITY_COSTS/DISCOUNT_COSTS/INCOME_COSTS и PCT_PER_LEVEL).

# Название специальной механики (Бизнес-экспансия: бонусные районы)
BIZ_EXPANSION_LABEL = "🏘 Бизнес-экспансия (бонусные районы)"

# Стоимость бизнес-расходников в магазине (NHCoin)
BIZ_SHOP_FRAG_PRICE_5   = 25_000   # 5 фрагментов
BIZ_SHOP_FRAG_PRICE_20  = 80_000   # 20 фрагментов
BIZ_SHOP_FRAG_PRICE_50  = 175_000  # 50 фрагментов
...
# Стоимость разблокировки в очках войны (последовательно: нельзя купить N без N-1)
