...
BUILDINGS: list[BuildingConfig] = [
    ...
    BuildingConfig("district_hq", "Деловой квартал","🌆",  "legal",    500,  28, 2),
    BuildingConfig("mafia",       "Мафия",          "☠️",  "illegal",  600,  28, 2),
    BuildingConfig("party_hq",    "Партийная машина","🌐", "political", 450,  28, 2),
