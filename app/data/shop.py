...
MG_TIERS: dict[str, list[PotionConfig]] = {
    ...
    # Тир 1–2: стали доступнее (~−15%). Тир 5–6: чуть дороже (~+10%).
    "power": [
        PotionConfig("mg_power_1", "⚔️ Зелье силы I",        "Мощь +30%, 30 мин",           "power",     30, 30,    17_000),
        PotionConfig("mg_power_2", "⚔️ Зелье силы II",       "Мощь +50%, 30 мин",           "power",     50, 30,    50_000),
        ...
        PotionConfig("mg_power_5", "⚔️ Зелье силы V",        "Мощь +125%, 30 мин",          "power",    125, 30, 1_750_000),
        PotionConfig("mg_power_6", "⚔️ Зелье силы VI",       "Мощь +150%, 30 мин",          "power",    150, 30, 5_500_000),
    ],
    "training": [
        PotionConfig("mg_train_1", "🏋 Зелье тренировки I",  "Тренировка +25%, 60 мин",     "training",  25, 60,    12_000),
        PotionConfig("mg_train_2", "🏋 Зелье тренировки II", "Тренировка +38%, 60 мин",     "training",  38, 60,    38_000),
        ...
        PotionConfig("mg_train_5", "🏋 Зелье тренировки V",  "Тренировка +100%, 60 мин",    "training", 100, 60, 1_320_000),
        PotionConfig("mg_train_6", "🏋 Зелье тренировки VI", "Тренировка +130%, 60 мин",    "training", 130, 60, 4_000_000),
    ],
    "income": [
        PotionConfig("mg_income_1", "💰 Зелье богатства I",  "Доход +40%, 60 мин",          "income",    40, 60,    16_000),
        PotionConfig("mg_income_2", "💰 Зелье богатства II", "Доход +70%, 60 мин",          "income",    70, 60,    50_000),
        ...
        PotionConfig("mg_income_5", "💰 Зелье богатства V",  "Доход +170%, 60 мин",         "income",   170, 60, 1_750_000),
        PotionConfig("mg_income_6", "💰 Зелье богатства VI", "Доход +200%, 60 мин",         "income",   200, 60, 5_500_000),
    ],
    "luck": [
        PotionConfig("mg_luck_1", "🍀 Зелье удачи I",        "Шанс тикета +5%, 30 мин",     "luck",       5, 30,    10_000),
        PotionConfig("mg_luck_2", "🍀 Зелье удачи II",       "Шанс тикета +9%, 30 мин",     "luck",       9, 30,    30_000),
        ...
        PotionConfig("mg_luck_5", "🍀 Зелье удачи V",        "Шанс тикета +21%, 30 мин",    "luck",      21, 30, 1_090_000),
        PotionConfig("mg_luck_6", "🍀 Зелье удачи VI",       "Шанс тикета +25%, 30 мин",    "luck",      25, 30, 3_300_000),
    ],
    "influence": [
        PotionConfig("mg_infl_1", "⚡ Зелье влияния I",      "Влияние +40%, 45 мин",        "influence", 40, 45,    15_000),
        PotionConfig("mg_infl_2", "⚡ Зелье влияния II",     "Влияние +60%, 45 мин",        "influence", 60, 45,    45_000),
        ...
        PotionConfig("mg_infl_5", "⚡ Зелье влияния V",      "Влияние +150%, 45 мин",       "influence",150, 45, 1_600_000),
        PotionConfig("mg_infl_6", "⚡ Зелье влияния VI",     "Влияние +200%, 45 мин",       "influence",200, 45, 4_800_000),
    ],
    "raid_drop": [
        PotionConfig("mg_raid_1", "💠 Зелье охотника I",     "Дроп +15%, 60 мин",           "raid_drop", 15, 60,    34_000),
        PotionConfig("mg_raid_2", "💠 Зелье охотника II",    "Дроп +25%, 60 мин",           "raid_drop", 25, 60,   100_000),
        ...
        PotionConfig("mg_raid_5", "💠 Зелье охотника V",     "Дроп +62%, 60 мин",           "raid_drop", 62, 60, 3_560_000),
        PotionConfig("mg_raid_6", "💠 Зелье охотника VI",    "Дроп +75%, 60 мин",           "raid_drop", 75, 60,10_700_000),
    ],
}
