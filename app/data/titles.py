...
ACHIEVEMENTS: list[Achievement] = [
    ...
    Achievement("prestige_max", "Пробуждённый до предела",
        "Достигни максимального уровня пробуждения (10)", "prestige_level", 10,
        "+150,000 NHCoin + +10% к доходу", "coins_and_income_10", 150_000,
        parent_id="prestige_3"),
...
CIRCULAR_DONATS: list[CircularDonat] = [
    ...
    CircularDonat(
        ...
        special_bonuses=(
            (3, "Получает 10% от дохода КАЖДОГО члена клана себе (доход самих членов не уменьшается)"),
            (5, "При пополнении казны: гарантированный кешбек 5-10% от суммы"),
        ),
    ),
    CircularDonat(
    ...
    CircularDonat(
        ...
        circle_bonus="Боевая сила +20%, влияние +10%, доход +5%, пассивный доход 400 NHCoin/час, вербовка +30%, стоимость у Тома Ли и Чон Гона -2%",
        special_bonuses=(
