    ...
    if not user.business_path:
        ...
        try:
            await cb.message.edit_text(
                ...
                "🔴 🕶 <b>Нелегальный</b>\n"
                "  −Влияние при постройке, +влияние при сносе. Лучший доход\n\n"
                "🔵 🏛 <b>Политика</b>\n"
                "  +Влияние при постройке, −влияние при сносе\n\n"
                "🟣 💻 <b>Цифровой</b>\n"
                "  Дешёвые районы + Сетевой эффект:\n"
                "  +10% к доходу за каждые 10 зданий (макс +50%)",
