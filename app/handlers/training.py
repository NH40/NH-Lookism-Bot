...
async def cb_training_menu(cb: CallbackQuery, session: AsyncSession, user: User):
    ...
    await cb.message.edit_text(
        ...
        + "\n".join(mastery_lines)
        + "\n\n"
        f"🥋 <b>Том Ли</b> — Гений боя, в его время все ходили с высокими порогами. "
        f"За скромную плату поможет прокачать мастерство.\n\n"
        f"🧘 <b>Чон Гон</b> — Гений тренировок, двое из его учеников открыли уникальный путь. "
        f"Кто знает, может и ты откроешь свой.\n\n"
