...
async def cb_training_menu(cb: CallbackQuery, session: AsyncSession, user: User):
    ...
    await cb.message.edit_text(
        ...
        f"Том ли - Гений боя, в его время все ходили с всеми порогами за скромную плату и он поможет тебе прокачать мастерство.\n\n",
        f"Чон гон - Гений тренировок, так уж вышло что двое из его учеников открыли свой уникальный путь, кто знает обучившись у него может ты тоже откроешь свой путь.\n\n",
