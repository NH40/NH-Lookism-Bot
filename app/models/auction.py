...
class AuctionLot(Base):
    ...
    reward_type: Mapped[str] = mapped_column(String(32), nullable=False)  # "character" | "coins" | "potion"
    reward_data: Mapped[str] = mapped_column(String(256), nullable=False)  # JSON-like string
