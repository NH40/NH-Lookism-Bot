...
def main_menu_kb(horse_shop_active: bool = False) -> InlineKeyboardMarkup:
    """Главный хаб — все кнопки Боя/Экономики/Прогресса сразу на виду, без подменю."""
    ...
    builder.row(InlineKeyboardButton(text="🏛 Аукцион", callback_data="auction"))
    ...
    builder.row(InlineKeyboardButton(text="🏋 Тренировка", callback_data="training_menu"))
    builder.row(InlineKeyboardButton(text="🏯 Кланы",      callback_data="clans_menu"))
    builder.row(InlineKeyboardButton(text="📋 Задания",    callback_data="daily_quests"))
